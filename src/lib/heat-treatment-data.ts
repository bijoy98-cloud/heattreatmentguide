...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  {
    term: "Extra Spring",
    definition: "A temper of nonferrous alloys and some ferrous alloys corresponding approximately to a cold-worked state above full hard beyond which further cold work will not measurably increase the strength and hardness."
  },
  {
    term: "Ferrite",
    definition: "A solid solution of one or more elements in body-centered cubic iron. Unless otherwise designated (for instance, as chromium ferrite), the solute is generally assumed to be carbon. On some equilibrium diagrams, there are two ferrite regions separated by an austenite area. The lower area is alpha ferrite; the upper, delta ferrite. If there is no designation, alpha ferrite is assumed."
  },
  {
    term: "Ferritizing Anneal",
    definition: "A treatment given as-cast gray or ductile (nodular) iron to produce an essentially ferritic matrix. For the term to be meaningful, the final microstructure desired or the time-temperature cycle used must be specified."
  },
  {
    term: "Final Annealing",
    definition: "An imprecise term used to denote the last anneal given to a nonferrous alloy prior to shipment."
  },
  {
    term: "Finish Annealing",
    definition: "A subcritical annealing treatment applied to cold-worked low- or medium-carbon steel. Finish annealing, which is a compromise treatment, lowers residual stresses, thereby minimizing the risk of distortion in machining while retaining most of the benefits to machinability contributed by cold working. Compare with final annealing."
  },
  {
  ...
  {
    term: "Fixturing",
    definition: "The placing of parts to be heat treated in a constraining or semiconstraining apparatus to avoid heat-related distortions. See racking."
  },
  {
    term: "Flame Annealing",
    definition: "Annealing in which the heat is applied directly by a flame."
  },
  {
    term: "Flame Hardening",
    definition: "A process for hardening the surfaces of hardenable ferrous alloys in which an intense flame is used to heat the surface layers above the upper transformation temperature, whereupon the workpiece is immediately quenched."
  },
  {
    term: "Flame Straightening",
    definition: "Correcting distortion in metal structures by localized heating with a gas flame."
  },
  {
    term: "Fluidized-Bed Heating",
    definition: "Heating carried out in a medium of solid particles suspended in a flow of gas."
  },
  {
    term: "Fog Quenching",
    definition: "Quenching in a fine vapor or mist."
  },
  {
    term: "Forced-Air Quench",
    definition: "A quench utilizing blasts of compressed air against relatively small parts such as a gear."
  },
  {
    term: "Free Carbon",
    definition: "The part of the total carbon in steel or cast iron that is present in elemental form as graphite or temper carbon. Contrast with combined carbon."
  },
  {
    term: "Free Ferrite",
    definition: "Ferrite that is formed directly from the decomposition of hypoeutectoid austenite during cooling, without the simultaneous formation of cementite. Also proeutectoid ferrite."
  },
  {
    term: "Freezing Range",
    definition: "That temperature range between liquidus and solidus temperatures in which molten and solid constituents coexist."
  },
  {
    term: "Full Annealing",
    definition: "An imprecise term that denotes an annealing cycle to produce minimum strength and hardness. For the term to be meaningful, the composition and starting condition of the material and the time-temperature cycle used must be stated."
  },
  {
    term: "Full Hard",
    definition: "A temper of nonferrous alloys and some ferrous alloys corresponding approximately to a cold-worked state beyond which the material can no longer be formed by bending. In specifications, a full hard temper is commonly defined in terms of minimum hardness or minimum tensile strength (or, alternatively, a range of hardness or strength) corresponding to a specific percentage of cold reduction following a full anneal. For aluminum, a full hard temper is equivalent to a reduction of 75% from dead soft; for austenitic stainless steels, a reduction of about 50 to 55%."
  },
  {
    term: "Gamma Iron",
    definition: "The face-centered cubic form of pure iron, stable from 910 to 1400 °C (1670 to 2550 °F)."
  },
  {
    term: "Gas Cyaniding",
    definition: "A misnomer for carbonitriding."
  },
  {
    term: "Grain-Boundary Liquation",
    definition: "An advanced stage of overheating in which material in the region of austenitic grain boundaries melts. Also termed burning."
  },
  {
    term: "Grain Coarsening",
    definition: "A heat treatment that produces excessively large austenitic grains."
  },
  {
    term: "Grain Growth",
    definition: "An increase in the average size of the grains in polycrystalline metal, usually as a result of heating at elevated temperature."
  },
  {
    term: "Grain Refiner",
    definition: "A material added to a molten metal to induce a finer-than-normal grain size in the final structure."
  },
  {
    term: "Grain Size",
    definition: "For metals, a measure of the areas or volumes of grains in a polycrystalline material, usually expressed as an average when the individual sizes are fairly uniform. In metals containing two or more phases, the grain size refers to that of the matrix unless otherwise specified. Grain sizes are reported in terms of number of grains per unit area or volume, average diameter, or as a grain-size number derived from area measurements."
  },
  {
    term: "Graphitic Carbon",
    definition: "Free carbon in steel or cast iron. See graphitization."
  },
  {
    term: "Graphitization",
    definition: "Formation of graphite in iron or steel. Where graphite is formed during solidification, the phenomenon is called primary graphitization; where formed later by heat treatment, secondary graphitization."
  },
  {
    term: "Graphitizing",
    definition: "Annealing a ferrous alloy in such a way that some or all of the carbon is precipitated as graphite."
  },
  {
    term: "Grossmann Chart",
    definition: "A chart describing the ability of a quenching medium to extract heat from a hot steel work-piece in comparison to still water."
  },
  {
    term: "Guinier-Preston (G-P) Zone",
    definition: "A small precipitation domain in a supersaturated metallic solid solution. A G-P zone has no well-defined crystalline structure of its own and contains an abnormally high concentration of solute atoms. The formation of G-P zones constitutes the first stage of precipitation and is usually accompanied by a change in properties of the solid solution in which they occur."
  },
  {
    term: "Half Hard",
    definition: "A temper of nonferrous alloys and some ferrous alloys characterized by tensile strength about mid-way between that of dead soft and full hard tempers."
  },
  {
    term: "Hardenability",
    definition: "The relative ability of a ferrous alloy to form martensite when quenched from a temperature above the upper critical temperature. Hardenability is commonly measured as the distance below a quenched surface where the metal exhibits a specific hardness (50 HRC, for example) or a specific percentage of martensite in the microstructure."
  },
  {
    term: "Hardening",
    definition: "Increasing hardness by suitable treatment, usually involving heating and cooling. When applicable, the following more specific terms should be used: age hardening, flame hardening, induction hardening, laser hardening, precipitation hardening, and quench hardening."
  },
  {
    term: "Hardness Profile",
    definition: "Hardness as a function of distance from a fixed reference point (usually from the surface)."
  },
  {
    term: "Hard Temper",
    definition: "Same as full hard temper."
  },
  {
    term: "Heat Tinting",
    definition: "Coloration of a metal surface through oxidation by heating to reveal details of the microstructure."
  },
  {
  ...
  },
  {
    ...
    definition: "A thin coating or film, usually an oxide, formed on the surface of metals during heat treatment."
  },
  {
    term: "Heat Treatment",
    definition: "Heating and cooling a solid metal or alloy in such a way as to obtain desired conditions or properties. Heating for the sole purpose of hot working is excluded from the meaning of this definition."
  },
  {
    term: "Holding",
    definition: "The portion of the thermal cycle during which the temperature of the object is maintained constant."
  },
  {
    term: "Holding Temperature",
    definition: "The constant temperature at which the object is maintained."
  },
  {
    term: "Holding Time",
    definition: "Time for which the temperature of the object is maintained constant."
  },
  {
    term: "Homogeneous Carburizing",
    definition: "Use of a carburizing process to convert a low-carbon ferrous alloy to one of uniform and higher carbon content throughout the section."
  },
  {
    term: "Homogenizing",
    definition: "Holding at high temperature to eliminate or decrease chemical segregation by diffusion."
  },
  {
    term: "Horizontal Batch Furnace",
    definition: "A versatile batch-type furnace that can give light or deep case depths, and because the parts are not exposed to air, horizontal batch furnaces can give surfaces almost entirely free of oxides."
  },
  {
    term: "Hot Quenching",
    definition: "An imprecise term used to cover a variety of quenching procedures in which a quenching medium is maintained at a prescribed temperature above 70 °C (160 °F)."
  },
  {
    term: "Hot-Wire Analyzer",
    definition: "An electrical atmosphere analysis device that is based on the fact that the electrical resistivity of steel is a linear function of carbon content over a range from 0.05% C to saturation. The device measures the carbon potential of furnace atmospheres (typically). This term is not to be confused with the hot-wire test which measures heat extraction rates."
  },
  {
    term: "Hot-Wire Test",
    definition: "Method used to test heat extraction rates of various quenchants. Faster heat-extracting quenchants will permit more electric current to pass through a standard wire because it is cooled more quickly. Compare with hot-wire analyzer."
  },
  {
    term: "Hypereutectic Alloy",
    definition: "In an alloy system exhibiting a eutectic, any alloy whose composition has an excess of alloying element compared with the eutectic composition, and whose equilibrium microstructure contains some eutectic structure."
  },
  {
    term: "Hypereutectoid Alloy",
    definition: "In an alloy system exhibiting a eutectoid, any alloy whose composition has an excess of alloying element compared with the eutectoid composition, and whose equilibrium microstructure contains some eutectoid structure."
  },
  {
    term: "Hypoeutectic Alloy",
    definition: "In an alloy system exhibiting a eutectic, any alloy whose composition has an excess of base metal compared with the eutectic composition, and whose equilibrium microstructure contains some eutectic structure."
  },
  {
    term: "Hypoeutectoid Alloy",
    definition: "In an alloy system exhibiting a eutectoid, any alloy whose composition has an excess of base metal compared with the eutectoid composition, and whose equilibrium microstructure contains some eutectoid structure."
  },
  {
    term: "Ideal Critical Diameter",
    definition: "(DI). Under an ideal quench condition, the bar diameter that has 50% martensite at the center of the bar when the surface is cooled at an infinitely rapid rate (that is, when H = , where H is the quench severity factor)."
  },
  {
    term: "Immersed-Electrode Furnaces",
    definition: "A furnace used for liquid carburizing of parts by heating molten salt baths with the use of electrodes immersed in the liquid. See submerged-electrode furnace."
  },
  {
    term: "Impact Tube",
    definition: "Same as Pitot tube."
  },
  {
    term: "Ion Carburizing",
    definition: "A method of surface hardening in which carbon ions are diffused into a workpiece in a vacuum through the use of high-voltage electrical energy. Synonymous with plasma carburizing or glow-discharge carburizing."
  },
  {
    term: "Ion Nitriding",
    definition: "A method of surface hardening in which nitrogen ions are diffused into a workpiece in a vacuum through the use of high-voltage electrical energy. Synonymous with plasma nitriding or glow-discharge nitriding."
  },
  {
    term: "Isothermal Annealing",
    definition: "Austenitizing a ferrous alloy and then cooling to and holding at a temperature at which austenite transforms to a relatively soft ferrite carbide aggregate."
  },
  {
    term: "Isothermal Transformation",
    definition: "A change in phase that takes place at a constant temperature. The time required for transformation to be completed, and in some instances the time delay before transformation begins, depends on the amount of supercooling below (or superheating above) the equilibrium temperature for the same transformation."
  },
  {
    term: "Isothermal Transformation (IT) Diagram",
    definition: "Set of curves drawn using logarithmic time and linear temperature as coordinates, which define for each level of temperature the beginning and end of the transformation of the initial phase under isothermal conditions."
  },
  {
    term: "Jominy Test",
    definition: "See end-quench hardenability test."
  },
  {
    term: "Kish",
    definition: "Free graphite that forms in molten hypereutectic cast iron as it cools. In castings, the kish may segregate toward the cope surface, where it lodges at or immediately beneath the casting surface."
  },
  {
    term: "Laser Hardening",
    definition: "A surface-hardening process which uses a laser to quickly heat a surface. Heat conduction into the interior of the part will quickly cool the surface, leaving a shallow martensitic layer."
  },
  {
    term: "Latent Heat",
    definition: "Thermal energy absorbed or released when a substance undergoes a phase change."
  },
  {
    term: "Ledeburite",
    definition: "The eutectic of the iron-carbon system, the constituents being austenite and cementite. The austenite decomposes into ferrite and cementite on cooling below the Ar1."
  },
  {
    term: "Leidenfrost Phenomenon",
    definition: "Slow cooling rates associated with a hot vapor blanket that surrounds a part being quenched in a liquid medium such as water. The gaseous vapor envelope acts as an insulator, thus slowing the cooling rate."
  },
  {
    term: "Liquation Temperature",
    definition: "The lowest temperature at which partial melting can occur in an alloy that exhibits the greatest possible degree of segregation."
  },
  {
    term: "Liquid Carburizing",
    definition: "Surface hardening of steel by immersion into a molten bath consisting of cyanides and other salts."
  },
  {
    term: "Liquid Nitriding",
    definition: "A method of surface hardening in which molten nitrogen-bearing, fused-salt baths containing both cyanides and cyanates are exposed to parts at subcritical temperatures."
  },
  {
    term: "Liquid Nitrocarburizing",
    definition: "A nitrocarburizing process (where both carbon and nitrogen are absorbed into the surface) utilizing molten liquid salt baths below the lower critical temperature."
  },
  {
    term: "Liquid Spray Quench",
    definition: "Same as spray quenching."
  },
  {
    term: "Localized Precipitation",
    definition: "Precipitation from a supersaturated solid solution similar to continuous precipitation, except that the precipitate particles form at preferred locations, such as along slip planes, grain boundaries, or incoherent twin boundaries."
  },
  {
    term: "Magnetic Test",
    definition: "Method used to test heat extraction rates of various quenchants. The test works by utilizing the change in magnetic properties of metals at their Curie point--the temperature above which metals lose their magnetism."
  },
  {
    term: "Malleable Cast Iron",
    definition: "A cast iron made by prolonged annealing of white cast iron in which decarburization or graphitization, or both, take place to eliminate some or all of the cementite. The graphite is in the form of temper carbon. If decarburization is the predominant reaction, the product will exhibit a light fracture surface, hence, \"whiteheart malleable;\" otherwise, the fracture surface will be dark, hence, \"blackheart malleable.\" Ferritic malleable has a predominantly ferritic matrix; pearlitic malleable may contain pearlitic, spheroidite or tempered martensite depending on heat treatment and desired hardness."
  },
  {
    term: "Malleablizing",
    definition: "Annealing white cast iron in such a way that some or all of the combined carbon is transformed to graphite or, in some instances, part of the carbon is removed completely."
  },
  {
    term: "Maraging",
    definition: "A precipitation-hardening treatment applied to a special group of iron-base alloys to precipitate one or more intermetallic compounds in a matrix of essentially carbon-free martensite."
  },
  {
    term: "Marquenching",
    definition: "See martempering."
  },
  {
    term: "Martempering",
    definition: "(1) A hardening procedure in which an austenitized ferrous workpiece is quenched into an appropriate medium whose temperature is maintained substantially at the Ms of the workpiece, held in the medium until its temperature is uniform throughout--but not long enough to permit bainite to form--and then cooled in air. The treatment is frequently followed by tempering. (2) When the process is applied to carburized material, the controlling Ms temperature is that of the case. This variation of the process is frequently called marquenching."
  },
  {
    term: "Martensite",
    definition: "A generic term for microstructures formed by diffusionless phase transformation in which the parent and product phases have a specific crystallographic relationship. Martensite is characterized by an acicular pattern in the microstructure in both ferrous and nonferrous alloys. In alloys where the solute atoms occupy interstitial positions in the martensitic lattice (such as carbon in iron), the structure is hard and highly strained; but where the solute atoms occupy substitutional positions (such as nickel in iron), the martensite is soft and ductile. The amount of high-temperature phase that transforms to martensite on cooling depends to a large extent on the lowest temperature attained, there being a rather distinct beginning temperature (Ms) and a temperature at which the transformation is essentially complete (Mf)."
  },
  {
    term: "Martensite Range",
    definition: "The temperature interval between Ms and Mf."
  },
  {
    term: "Martensitic Transformation",
    definition: "A reaction that takes place in some metals on cooling, with the formation of an acicular structure called martensite."
  },
  {
    term: "McQuaid-Ehn Test",
    definition: "A test to reveal grain size after heating into the austenitic temperature range. Eight standard McQuaid-Ehn grain sizes rate the structure, No. 8 being finest, No. 1 coarsest."
  },
  {
    term: "Mf Temperature",
    definition: "For any alloy system, the temperature at which martensite formation on cooling is essentially finished. See transformation temperature for the definition applicable to ferrous alloys."
  },
  {
    term: "Microhardness",
    definition: "The hardness of a material as determined by forcing an indenter such as a Vickers or Knoop indenter into the surface of a material under very light load; usually, the indentations are so small that they must be measured with a microscope. Capable of determining hardnesses of different microconstituents within a structure, or of measuring steep hardness gradients such as those encountered in case hardening."
  },
  {
    term: "Microscopic Stresses",
    definition: "Residual stresses that vary from tension to compression in a distance (presumably approximating the grain size) that is small compared with the gage length in ordinary strain measurements. They are not detectable by dissection methods, but can sometimes be measured from line shift or line broadening in an x-ray diffraction pattern."
  },
  {
    term: "Microsegregation",
    definition: "Segregation within a grain, crystal, or small particle."
  },
  {
    term: "Mill Scale",
    definition: "The heavy oxide layer formed during hot fabrication or heat treatment of metals."
  },
  {
    term: "Monotropism",
    definition: "The ability of a solid to exist in two or more forms (crystal structures), but in which one form is the stable modification at all temperatures and pressures. Ferrite and martensite are a monotropic pair below Ac1 in steels, for example. May also be spelled monotrophism."
  },
  {
    term: "Ms Temperature",
    definition: "For any alloy system, the temperature at which martensite starts to form on cooling. See transformation temperature for the definition applicable to ferrous alloys."
  },
  {
    term: "Natural Aging",
    definition: "Spontaneous aging of a supersaturated solid solution at room temperature. See aging, and compare with artificial aging."
  },
  {
    term: "Neutral Flame",
    definition: "A gas flame in which there is no excess of either fuel or oxygen in the inner flame. Oxygen from ambient air is used to complete the combustion of CO2 and H2 produced in the inner flame."
  },
  {
    term: "Neutralization Number",
    definition: "An ASTM number given to quenching oils that reflects the oil's tendency towards oxidation and sludging. See saponification number."
  },
  {
    term: "Nitriding",
    definition: "Introducing nitrogen into the surface layer of a solid ferrous alloy by holding at a suitable temperature (below Ac1 for ferritic steels) in contact with a nitrogenous material, usually ammonia or molten cyanide of appropriate composition. Quenching is not required to produce a hard case. See aerated bath nitriding, bright nitriding, and liquid nitriding."
  },
  {
    term: "Nitrocarburizing",
    definition: "Any of several processes in which both nitrogen and carbon are absorbed into the surface layers of a ferrous material at temperatures below the lower critical temperature and, by diffusion, create a concentration gradient. Nitrocarburizing is done mainly to provide an antiscuffing surface layer and to improve fatigue resistance. Compare with carbonitriding."
  },
>;
