...
export default function CalculatorsPage() {
  const calculatorsParent = navItems.find(item => item.href === '/calculators');
  const calculatorFeatures = calculatorsParent?.children || [];
          ...
          <div className="relative z-10 space-y-6">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-4xl font-bold tracking-tight">
                Heat Treating Calculators
              </h1>
            </div>
            <p className="max-w-3xl text-lg text-muted-foreground text-justify">
              Access our suite of heat treatment calculators, from rule-based parameter finders to advanced AI-powered process generators.
            </p>
          </div>
